...
def createDialog():
    ...
    #~ dialogModel.insertByName( "buttonRefreshObjet",buttonRefreshObjet)
    dialogModel.insertByName( "buttonImport", buttonModel) 
    #~ dialogModel.insertByName( "buttonColonnes", buttonColonnes) 
    ...
    #~ controlContainer.getControl("buttonRefreshObjet").addActionListener(
        #~ RefreshObjetListener(controlContainer.getControl( "serveur" ), controlContainer.getControl( "user" ), controlContainer.getControl( "mdp" ), controlContainer.getControl( "objet" ), controlContainer.getControl( "port" ),controlContainer.getControl( "base" ),controlContainer.getControl( "objet" )))
    
    #~ controlContainer.getControl("buttonColonnes").addActionListener(
        #~ RefreshColonnesListener(controlContainer.getControl( "serveur" ), controlContainer.getControl( "user" ), controlContainer.getControl( "mdp" ),  controlContainer.getControl( "port" ),controlContainer.getControl( "objet" ),controlContainer.getControl( "base" ),controlContainer.getControl( "colonnes" )))
    ...
    #   compteur_base=compteur_base+1
    #   controlContainer.getControl("base").addItem(db,compteur_base)
    # create a peer 
